...
public class MazeJAVAKASAL {
    ...
    public MazeJAVAKASAL(int aDimension) {
        // Initialize
        this(aDimension, aDimension);
    }
    // constructor
    public MazeJAVAKASAL(int xDimension, int yDimension) {
    ...
    public void solve(int startX, int startY, int endX, int endY) {
        ...
        while (solving) {
            ...
            if (current == endCell) break; // we have reached the end
    ...
    public void updateGrid() {
        char backChar = ' ', wallChar = 'X', cellChar = ' ', pathChar = 'o';
        // fill background
    ...
    public static void main(String[] args) {
        MazeJAVAKASAL maze = new MazeJAVAKASAL(20);
        maze.solve();
        maze.draw();
    }
}